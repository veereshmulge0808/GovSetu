                            ...
                            if (process.env.NODE_ENV === 'development') {
                                ...
                                this.$on('query', function (event) {
                                    if (event.duration > 500) {
                                        _this.logger.warn("Slow query (".concat(event.duration, "ms): ").concat(event.query));
                                    }
                                });
                            }
                            return [2 /*return*/];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, this.$executeRawUnsafe("TRUNCATE TABLE \"public\".\"".concat(tablename, "\" CASCADE;"))];
                        case 3:
                            _a.sent();
                            _a.label = 4;
                        case 4:
