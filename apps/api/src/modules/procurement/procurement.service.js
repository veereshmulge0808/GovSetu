...
var ProcurementService = function () {
    ...
    var _classThis;
    var ProcurementService = _classThis = /** @class */ (function () {
        function ProcurementService_1(prisma) {
            this.prisma = prisma;
        }
        ProcurementService_1.prototype.findAll = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, { message: 'Procurement module — implementation coming next' }];
                });
            });
        };
        return ProcurementService_1;
    }());
