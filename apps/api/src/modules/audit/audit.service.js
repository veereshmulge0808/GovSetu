...
var AuditService = function () {
    ...
    var AuditService = _classThis = /** @class */ (function () {
        ...
        AuditService_1.prototype.findAll = function (user, filters) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            page = Math.max(1, parseInt((_b = filters.page) !== null && _b !== void 0 ? _b : '1', 10));
                            limit = Math.min(100, parseInt((_c = filters.limit) !== null && _c !== void 0 ? _c : '50', 10));
                            skip = (page - 1) * limit;
                            where = {};
