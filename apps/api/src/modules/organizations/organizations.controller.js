...
var OrganizationsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Organizations'), (0, swagger_1.ApiBearerAuth)('JWT-Auth'), (0, common_1.Controller)({ path: 'organizations', version: '1' })];
    ...
    (function () {
        ...
        _findAll_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'List organizations' })];
