...
var ApplicationsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Applications'), (0, swagger_1.ApiBearerAuth)('JWT-Auth'), (0, common_1.Controller)({ path: 'applications', version: '1' })];
    ...
    var ApplicationsController = _classThis = /** @class */ (function () {
        ...
        ApplicationsController_1.prototype.findAll = function () {
    ...
    (function () {
        ...
        _findAll_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'List applications' })];
