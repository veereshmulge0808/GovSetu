...
var NotificationsService = function () {
    ...
    var NotificationsService = _classThis = /** @class */ (function () {
         ...
         */
        NotificationsService_1.prototype.createNotification = function (payload) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            this.logger.debug("Notification created for user ".concat(payload.userId, ": ").concat(payload.title));
         ...
         */
        NotificationsService_1.prototype.getMyNotifications = function (userId_1) {
            return __awaiter(this, arguments, void 0, function (userId, onlyUnread, page, limit) {
                    ...
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, Promise.all([
                                    ...
                                    this.prisma.notification.count({ where: { userId: userId, status: 'UNREAD' } }),
                                ])];
                        case 1:
                            _a = _b.sent(), notifications = _a[0], total = _a[1], unreadCount = _a[2];
                            return [2 /*return*/, {
                                    data: notifications,
                                    meta: { total: total, page: page, limit: limit, totalPages: Math.ceil(total / limit), unreadCount: unreadCount },
                                }];
                    }
                });
            });
        ...
        NotificationsService_1.prototype.findAll = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, { message: 'Use /notifications/me to get your notifications' }];
                });
            });
        };
