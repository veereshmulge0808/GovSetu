    ...
    var HttpExceptionFilter = _classThis = /** @class */ (function () {
        ...
        HttpExceptionFilter_1.prototype.catch = function (exception, host) {
            ...
            if (typeof exceptionResponse === 'object' && exceptionResponse !== null) {
                var exRes = exceptionResponse;
                message = (_a = exRes.message) !== null && _a !== void 0 ? _a : exception.message;
                error = (_b = exRes.error) !== null && _b !== void 0 ? _b : common_1.HttpStatus[status];
            }
            else {
            ...
            if (status >= 500) {
                this.logger.error("[".concat(request.method, "] ").concat(request.url, " \u2192 ").concat(status), exception.stack);
            }
            else if (status >= 400) {
